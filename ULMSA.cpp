//this program is abbout working of LMS(lerning mangement system)
//this program can add new courses,delete courses,edit course,view all course and view courses by semester
#include<iostream>
#include<iomanip>
#include<fstream>
using namespace std;
...
{
for(int i=0;i<counter;i++)
 cout<<setw(13)<<left<<codelist[i]<<setw(31)<<left<<namelist[i]<<setw(15)<<left<<creditlist[i]<<setw(10)<<left<<semesterlist[i]<<endl;
...
int main()
{
    ...
    int credit;
    int semester;
    cout<<setw(75)<<"**WELCOME TO UNVERESTY MANGEMENT SYSTEM**"<<endl<<endl;
	//MAIN PART OF PROGRAM
	while(*function!='6')     //loop used for repetition of program
{   //interface
	cout<<setw(72)<<"Choose an option from the following"<<endl<<endl<<setw(55)<<"1    Add Course"<<endl<<setw(58)<<"2    Update Course"<<endl<<setw(58)<<"3    Delete Course"<<endl<<setw(61)<<"4    Veiw All Courses"<<endl<<setw(71)<<"5    View Courses Of A Semester"<<endl<<setw(57)<<"6    Exit Program"<<endl<<endl<<endl;
    //
    if(cin.fail())
    {
